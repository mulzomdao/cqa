                                ...
                                <fieldset class="form-horizontal">
                                    ...
                                    <form role="form" id="office_add" action="office_crud.php" method="post">
                                        ...
                                        <div class="form-group" style="margin-bottom: 5px">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="col-sm-6" style="padding-left: 0px; padding-right: 2px">
                                                    <input type="text" class="form-control input-sm" name="office_num" id="office_num" value="<?echo $row[office_num]?>" placeholder="지회번호">
                                                </div>
                                                <div class="col-sm-6" style="padding-left: 2px; padding-right: 0px">
                                                    <input type="text" class="form-control input-sm" name="sub_office_num" id="sub_office_num" value="<?echo $row[sub_office_num]?>" placeholder="지부번호">
                                                </div>                                            
                                            </div>
                                        ...
                                        <div class="form-group" style="margin-bottom: 0px">                             
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <div class="col-sm-9" style="padding-left: 4px; padding-right: 0px;">
                                                    <input type="text" class="form-control input-sm" name="shop_zip_address" id="shop_zip_address" value="<?echo $row[shop_zip_adress]?>">
                                                </div>
                                        ...
                                        <div class="form-group" style="margin-bottom: 5px">
                                            ...
                                            <div class="col-sm-5"><input type="text" class="form-control input-sm" name="reg_info" id="reg_id" value="" readonly></div>
                                        </div>
                                        <div class="form-group" style="margin-bottom: 5px">
