...
<body>    
    ...
    <div class="container mb30" style="padding-left: 30px; padding-right: 30px;">
        ...
        <h4 class="mb10">공지사항상세</h4>
        <div class="row">
            <div class="col-md-12">
                <div class="form-group row" style="margin-bottom: 5px">
                    <label for="example-text-input" class="col-1 col-form-label text-right" style="padding-right: 0px">성명</label>
                    <div class="col-11">          
                        <input class="form-control form-control-sm" type="text" value="관리자" id="example-search-input" readonly style="background-color: white;">
                    </div>
                </div>
                <div class="form-group row" style="margin-bottom: 5px">
                    <label for="example-text-input" class="col-1 col-form-label text-right" style="padding-right: 0px">등록일</label>
                    <div class="col-5">          
                        <input class="form-control form-control-sm" type="text" value="2017-03-22 12:33:24" id="example-search-input" readonly style="background-color: white;">
                    </div>
                    <label for="example-text-input" class="col-1 col-form-label text-right" style="padding-right: 0px">조회수</label>
                    <div class="col-5">          
                        <input class="form-control form-control-sm" type="text" value="69" id="example-search-input" readonly style="background-color: white;">
                    </div>
                </div>
                <div class="form-group row" style="margin-bottom: 2px">
                    <label for="example-text-input" class="col-1 col-form-label text-right" style="padding-right: 0px">제목</label>
                    <div class="col-11">
                        <input class="form-control form-control-sm" type="text" value="한국퀼트연합 자격정보 안내" id="example-text-input" readonly style="background-color: white;">
                    </div>
                </div>
                <div class="form-group row" style="margin-bottom: 5px">
                    <label for="example-text-input" class="col-1 col-form-label text-right" style="padding-right: 0px">첨부파일</label>
                    <div class="col-11" style="padding-top: 6px;">      
                        자격정보안내.doc
                    </div>
                </div>
                <div class="form-group row" style="margin-bottom: 5px">
                    ...
                    <div class="col-11">
                        <textarea class="form-control form-control-sm" id="example-textarea" rows="16" readonly style="background-color: white;">2017년 하반기 부터 실시되는 자격발급정보입니다.
